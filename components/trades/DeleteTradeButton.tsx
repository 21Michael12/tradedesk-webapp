...
export default function DeleteTradeButton({ tradeId, tradeLabel }: DeleteTradeButtonProps) {
          ...
          <div className="bg-surface-container border border-outline-variant rounded-xl w-full max-w-[28rem] overflow-hidden shadow-2xl">
            <div className="p-5 flex flex-col gap-3">
              <div className="flex items-center gap-2 text-error">
                ...
                <h2 className="font-title-md text-title-md">למחוק את העסקה?</h2>
              </div>
              <p className="font-body-md text-body-md text-on-surface">
                <span className="font-data-mono font-semibold">{tradeLabel}</span> תימחק לצמיתות, יחד עם צילומי המסך.
              </p>
              {error && (
